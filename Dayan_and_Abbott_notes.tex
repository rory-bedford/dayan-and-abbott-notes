...
\begin{equation*}
    L(t) = \int_0^\infty \int dx dy D(x,y,\tau)s(x,y,t-\tau)
\end{equation*}
...
This can be used just like before to predict a neuron's activity from a stimulus, through either the linear or static non-linear models discussed before.\\
